<template>
    <div>
        ...
        <div class="mrg-b10 ">
            <hjx-underline-input label="发放总额上限" type='number' width="50" disabled v-model="upperLimitAmount" :textCenter="true"></hjx-underline-input><span class="underline-text">元 / 整个时间段</span>
    ...
    methods: {
    	...
    	setDeault(){
    		api.search_activity_detail({activityId:this.$route.query.id}).then(res=>{
                ...
                this.directAmount = String(res.directAmount / 100)
