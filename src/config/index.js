...
export default { 
	...
	JSONP_URL: process.env.NODE_ENV == 'development' ? 'http://10.0.10.67:8080/index/index' : process.env.NODE_ENV == 'production' ? 'XXX' : 'XXXX',//本地开发环境(志鹏)、243测试环境
	UPLOAD_URL: process.env.NODE_ENV == 'development' ? 'http://10.0.10.67:8080/index/index' : process.env.NODE_ENV == 'production' ? 'XXX' : 'XXXX',//本地开发环境(志鹏)、243测试环境
